...
final class ThemeSetCustomizerAbility extends AbstractAbility {
	...
	protected function input_schema(): array { return [ 'additionalProperties' => false, 'required' => [ 'key', 'value' ], 'properties' => [ 'key' => [ 'type' => 'string' ], 'value' => [ 'description' => 'New customizer value (any JSON type).' ] ] ]; }
